    ...
    .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      ...
      .subt.mb-4(data-aos="fade-right")
        .row.align-items-center
          ...
          .col-auto
            h3.mb-0.text-white Clasificación general de la carne
      ...
      .row.bgc-3.align-items-center.p-3.mb-5(data-aos="fade-down")
      ...
      p Las características sensoriales de la carne son importantes, dado que permiten la identificación de posibles alteraciones. Además, son la manera como el consumidor identifica al producto y lo califica de acuerdo con sus gustos y/o preferencias (Jurado – Gámez & Insuasty – Santacruz, 2021). 
