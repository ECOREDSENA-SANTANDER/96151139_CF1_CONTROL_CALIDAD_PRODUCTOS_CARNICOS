        ...
        .row.justify-content-center.align-items-center
          ...
          .row.justify-content-center.align-items-center(data-aos="fade-down")
            .col-lg-12
              figure
                .video
                  iframe(width="560" height="315" src="https://www.youtube.com/embed/FDMhhU2EH3Y?si=bMVY0njrdCDuTeKi" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
              figcaption #[b Video.] Generalidades de la carne y sus derivados - introducción
